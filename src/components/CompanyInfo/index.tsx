...
const CompanyInfo = () => {
  ...
  const teamInfo = [
    {firstname: "Prénom1", lastname: "Nom", email: "Email", phone: "Téléphone", service: "Nom du service"},
    {firstname: "Prénom2", lastname: "Nom", email: "Email", phone: "Téléphone", service: "Nom du service"},
    {firstname: "Prénom3", lastname: "Nom", email: "Email", phone: "Téléphone", service: "Nom du service"},
  ]
  return (
      ...
      <table>
        ...
        <tbody>
            ...
            {compagny.map((info: any) => {
              return <tr><td key={uuidv4()}>{info.name}</td><td>{info.value}</td></tr>;
            })}
